            ...
            <Modal blockScrollOnMount={false} isOpen={isOpen} onClose={onClose} scrollBehavior="inside">
                ...
                <ModalContent>
                                ...
                                <CardBody>
                                    <form onSubmit={handleSubmit(onSubmit)} id="user_form">
                                        <VStack spacing={6}>
                                            ...
                                            <FormControl>
                                                <Select placeholder='depId' onClick={selectSubmit}>
                                                    {list.map((list) => (
                                                        <option {...register('depId')} value={list.depId}>{list.departmentName}</option>
                                                    ))}
                                                </Select>
                                            </FormControl>
                                            <FormControl>
                                            ...
                                            <FormControl>
                                                <Select placeholder='部门' onClick={selectJobLevelSubmit}>
                                                    {jobLevel.map((item) => (
                                                        <option {...register('department')} value={item.department}>
                                                            {item.department}
                                                        </option>
                                                    ))}
                                                </Select>
                                            ...
                                            <FormControl>
                                                <Select placeholder='职位' onClick={selectJobLevelSubmit}>
                                                    {jobLevel.map((item) => (
                                                        <option {...register('positionName')} value={item.positionName}>
                                                            {item.positionName}
                                                        </option>
                                                    ))}
                                                </Select>
                                            ...
                                            <FormControl>
                                                <Select placeholder='工资' onClick={selectJobLevelSubmit}>
                                                    {jobLevel.map((item) => (
                                                        <option {...register('baseSalary')} value={item.baseSalary}>
                                                            {item.baseSalary}
                                                        </option>
                                                    ))}
                                                </Select>
                    ...
                    <ModalFooter>
                        ...
                        <Button variant='ghost' form="user_form" type="submit">确定修改</Button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </>
